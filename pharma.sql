...
--
-- Host: localhost    Database: mukunda
-- ------------------------------------------------------
...
CREATE TABLE `patient` (
  ...
  `discharged` int(2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `stock` (
  ...
  `terminate` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2016-08-08  7:46:29
